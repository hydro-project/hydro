// TODO(inline): dfir_expect_warnings! macro has hygiene issues with inline codegen.
// The macro passes dataflow code as a tt to dfir_syntax_noemit!, which changes
// the hygiene context and prevents the closure from accessing __dfir_work_done
// and __dfir_metrics. Needs macro rework to fix.
