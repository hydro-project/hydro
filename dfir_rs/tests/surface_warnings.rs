// TODO(cleanup): dfir_expect_warnings! has macro hygiene issues with inline codegen.
// The __dfir_work_done variable generated by the proc macro is not visible through
// the declarative macro boundary. Fix dfir_expect_warnings! or replace with a
