...
impl DfirBuilder for SimBuilder {
    ...
    fn merge_ordered(
        ...
        // Keyed streams carry no ordering guarantee across keys, so their merge
        // must interleave *per key* rather than treating the whole batch as one
        // totally-ordered sequence. This requires dedicated keyed sim hooks.
