...
impl<'a, L: Location<'a>> Slicable<'a, L> for () {
    ...
    fn get_location(&self) -> &L {
        panic!("Cannot get location of empty tuple");
    }
...
impl<'a, K, V, L: Location<'a>> Unslicable for super::KeyedStream<K, V, Tick<L>, Bounded> {
    type Unsliced = super::KeyedStream<K, V, L, Unbounded>;
