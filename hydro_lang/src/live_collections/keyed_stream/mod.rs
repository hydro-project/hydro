...
/// be deterministic.
///
/// Although keyes streams are conceptually grouped by keys, keys are not immediately
...
{
    /// Shifts this keyedstream into an atomic context, which guarantees that any [`Clone`]ed branches
