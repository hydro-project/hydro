...
impl Backtrace {
    ...
    ///
    /// Excludes all backtrace elements up to the original [`Backtrace::get_backtrace`]
    /// call as well as additional skipped frames from that call. Also drops the suffix
...
impl Debug for BacktraceElement {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        // addr is unstable across platforms so we drop it
