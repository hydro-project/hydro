...
impl<'a, L: DynLocation> DynLocation for Atomic<L> {
...
impl<'a, L: DynLocation> DynLocation for Tick<L> {
    fn id(&self) -> LocationId {
    ...
    L: Location<'a>,
{
    ...
    pub fn cycle<S>(&self) -> (ForwardHandle<'a, S>, S)
    where
    ...
    pub fn cycle_with_initial<S>(&self, initial: S) -> (ForwardHandle<'a, S>, S)
    where
