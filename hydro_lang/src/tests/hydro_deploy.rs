...
#![allow(
    ...
    missing_docs,
    unused_imports,
    reason = "Test code does not count as using the imports, and this module cannot be put under #cfg(test) because of stageleft."
)]
...
#[tokio::test]
async fn docker() {
    telemetry::initialize_tracing_with_directive("trace,hyper=off");
