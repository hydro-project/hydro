        ...
        self.build(
                move |new_leader_elected| {
                    ...
                    let payloads_at_proposer = {
                        ...
                        let payload_batch = payloads.batch(&client_tick, local_nondet("see below"));

                        let latest_leader = cur_leader_id.latest_tick(&client_tick, partial_exposed_nondet("
                    ...
                    let payloads_at_proposer = {
                        payloads_at_proposer.assume_ordering(partial_exposed_nondet(
