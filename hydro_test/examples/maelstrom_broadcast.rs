...
//! ```bash
//! nix shell nixpkgs#graphviz nixpkgs#gnuplot -c cargo run -p hydro_test --features maelstrom --example maelstrom_broadcast -- --maelstrom-path $HOME/Downloads/maelstrom/maelstrom --node-count 5 --time-limit 20
//! ```
