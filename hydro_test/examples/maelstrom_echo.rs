...
//! ```bash
//! nix shell nixpkgs#graphviz nixpkgs#gnuplot -c cargo run -p hydro_test --features maelstrom --example maelstrom_echo -- --maelstrom-path $HOME/Downloads/maelstrom/maelstrom
//! ```
