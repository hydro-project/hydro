  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Hydro is a project co-led by open-source developers from Amazon Web Services, the <a href="https://sky.cs.berkeley.edu">Sky Computing Lab</a> at UC Berkeley, and various participating institutions.`,
      },
      prism: {
        theme: themes.github,
