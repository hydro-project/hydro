...
export function Hydroscope({ data, height = 600, width = '100%' }: HydroscopeProps) {
  ...
  return (
    <div style={style}>
      ...
      <p style={{ color: '#6b7280', marginTop: 4 }}>
        The real @hydro-project/hydroscope package is not available during this build.
      </p>
...
export async function parseDataFromUrl(
  ...
  try {
    ...
    console.warn('Hydroscope shim failed to parse URL data, returning null:', e);
    return null;
  }
}
