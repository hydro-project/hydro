    ...
    <Layout description="Members of the Hydro research group">
      ...
      <main>
        <div className={styles["container"]}>
          ...
          <p className={styles["blurb"]}>Hydro's open-source community is governed by the <b>Core Team</b>, consisting of the original researchers: Joe Hellerstein, David Chu, Lucky Katahanas, Shadaj Laddad, Conor Power, and Mingwei Samuel. New <b>Core Team</b> and <b>Committer</b> members are approved via a public GitHub review process. All governance decisions, including membership and general policy changes, require approval from a majority of Core Team members (affirmative votes > negative + absences). Committers have write access to the core Hydro repositories, but only Core Team members can cast votes for governance decisions.</p>
          <div>
