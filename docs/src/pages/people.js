    ...
    <Layout description="Members of the Hydro research group">
      ...
      <main>
        <div className={styles["container"]}>
          ...
          <p className={styles["blurb"]}>Hydro's open-source community is governed by <b>Project Leaders</b>, consisting of the original researchers: Joe Hellerstein, David Chu, Lucky Katahanas, Shadaj Laddad, Conor Power, and Mingwei Samuel. New <b>Project Leaders</b> and <b>Committers</b> are approved via a public GitHub review process. All governance decisions, including membership and general policy changes, require approval of all Project Leaders. Committers have write access to the core Hydro repositories, but only Project Leaders can cast votes for governance decisions.</p>
          <div>
