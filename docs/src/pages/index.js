      ...
      <main>
        ...
        <div className={styles["panel"]}>
          <div style={{
            ...
            <p>
              Hydro is a correctness-first framework, helping you avoid distributed systems bugs at each stage of development. Just like Rust ensures memory safety through the borrow checker, Hydro ensures <i>distributed safety</i> through <b>stream types</b>. These types come have <b>zero runtime overhead</b>; you retain full control over the network protocol, compute placement, and serialization format, 
            </p>
            ...
            <div style={{
              ...
              <b>In Development (<a style={{ color: "#5c98ff" }} href={"https://github.com/hydro-project/hydro/issues/1876"}>#1876</a>)</b>
              <p style={{
                fontSize: "0.9em",
                marginBottom: 0,
              }}>Hydro will soon offer a built-in <b>deterministic simulation testing</b> engine, allowing you to locally simulate various distributed scenarios, including network partitions, message delays, and failures.</p>
            </div>
          </div>

          <div style={{ marginBottom: "20px", flexGrow: 1, minWidth: "450px", maxWidth: "700px", display: "flex", justifyContent: "center", flexDirection: "column" }}>
            <iframe
              style={{
                display: "block",
                marginLeft: "auto",
        ...
        <div className={styles["panel"]}>
          <div style={{
            ...
            <div style={{
              ...
              <b>Coming Soon (<a style={{ color: "#5c98ff" }} href={"https://github.com/hydro-project/hydro/issues/1890"}>#1890</a>)</b>
              <p style={{
                fontSize: "0.9em",
                marginBottom: 0,
          ...
          <div style={{ marginBottom: "20px", flexGrow: 1, minWidth: "450px", width: "0px", maxWidth: "700px", display: "flex", justifyContent: "center", flexDirection: "column" }}>
            <img
        ...
        <div className={styles["panel"]} style={{ paddingBottom: "80px"}}>
          <div style={{
            flexGrow: 1,
            maxWidth: "650px"
          }}>
          ...
          <div style={{ flexGrow: 1, minWidth: "450px", width: "0px", maxWidth: "700px", display: "flex", justifyContent: "center", flexDirection: "column" }}>
            <img
