      ...
      <main>
        ...
        <div className={styles["panel"]}>
          <div style={{
            ...
            <p>Quorum counting? Two-Phase Commit? Each a single function in Hydro's standard library. Want just the leader-election piece of Paxos? It's already a separate module. Hydro unlocks new opportunities to share distributed code across your organization with confidence.</p>
          </div>

          <div className={styles["panelImage"]} style={{ fontSize: "16px", flexShrink: 1, flexBasis: "10%" }}>
            <CodeBlock
          language="rust">
