/**
 * Vis System v3 (Bridge Architecture)
 * 
 * Previous version of the graph visualization system using bridge architecture.
 * Features file upload, JSON parsing, and ReactFlow v12 + ELK layout visualization.
 * 
 * Note: This is the v3 version - the latest version is available at /vis
 */
...
function VisHomepageComponent() {
  ...
  React.useEffect(() => {
    ...
    const loadComponents = async () => {
      try {
        const visStateModule = await import('../components/_DEPRECATED_/visualizer_v3/core/VisState.ts');
        const FlowGraphModule = await import('../components/_DEPRECATED_/visualizer_v3/render/FlowGraph.tsx');
        const constantsModule = await import('../components/_DEPRECATED_/visualizer_v3/shared/constants.ts');
        const parserModule = await import('../components/_DEPRECATED_/visualizer_v3/core/JSONParser.ts');
        const componentsModule = await import('../components/_DEPRECATED_/visualizer_v3/components/index.ts');
...
export default function VisHomepage() {
  return (
    <Layout
      title="Graph Visualizer v3"
      description="Interactive graph visualization v3 (Bridge Architecture) - Latest version at /vis">
      <main>
