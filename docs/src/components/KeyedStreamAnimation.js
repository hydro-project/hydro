...
const KeyedStreamAnimation = () => {
    const setupAnimation = (world) => {
        ...
        const keyGroups = {
            'A': world.createKeyGroup('keyA', new Point(inputContainer.getContentCenter().x, keyGroupPositions[0]), 140, 50, 'Key A', '#4CAF50'),
            'B': world.createKeyGroup('keyB', new Point(inputContainer.getContentCenter().x, keyGroupPositions[1]), 140, 50, 'Key B', '#2196F3'),
            'C': world.createKeyGroup('keyC', new Point(inputContainer.getContentCenter().x, keyGroupPositions[2]), 140, 50, 'Key C', '#FF9800')
        };
