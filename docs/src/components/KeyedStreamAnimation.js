...
const KeyedStreamAnimation = () => {
    const setupAnimation = (world) => {
        ...
        const keyGroups = {
            'A': world.createKeyGroup('keyA', new Point(inputContainer.getContentCenter().x, keyGroupPositions[0]), 140, 50, 'Key A', HydroColors.getKeyColor(0)),
            'B': world.createKeyGroup('keyB', new Point(inputContainer.getContentCenter().x, keyGroupPositions[1]), 140, 50, 'Key B', HydroColors.getKeyColor(1)),
            'C': world.createKeyGroup('keyC', new Point(inputContainer.getContentCenter().x, keyGroupPositions[2]), 140, 50, 'Key C', HydroColors.getKeyColor(2))
        };
