...
export type SceneKey = "grpc" | "global" | "correctness" | "sim" | "cloud";
...
export const SCENES: Record<SceneKey, Scene> = {
  ...
  grpc: {
    ...
    bars: [
      { id: "b-c1", x: 50, y: 87, w: 190 },
      { id: "b-c2", x: 50, y: 107, w: 240 },
      { id: "b-c3", x: 50, y: 127, w: 150 },
      { id: "b-c4", x: 50, y: 147, w: 205 },
      { id: "b-s1", x: 50, y: 306, w: 215 },
      { id: "b-s2", x: 50, y: 326, w: 160 },
      { id: "b-s3", x: 50, y: 346, w: 235 },
      { id: "b-s4", x: 50, y: 366, w: 180 },
    ],
    ops: [],
    edges: [
      {
