...
export class VisualizationState {
    ...
    getNodeContainer(nodeId) {
        return __classPrivateFieldGet(this, _VisualizationState_nodeContainers, "f").get(nodeId);
    }
    /**
     * Clear all data
     */
...
Object.assign(VisualizationState.prototype, {
     ...
     */
    setManualPosition(elementId, x, y) {
