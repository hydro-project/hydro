...
export function Legend({ colorPalette = 'Set3', graphData, onPositionChange }) {
    ...
    return (_jsx(DockablePanel, { id: "legend", title: legendData.title, defaultPosition: DOCK_POSITIONS.TOP_RIGHT, defaultDocked: true, defaultCollapsed: false, onPositionChange: onPositionChange, minWidth: 200, minHeight: 150, children: _jsx("div", { children: legendData.items.map(item => {
