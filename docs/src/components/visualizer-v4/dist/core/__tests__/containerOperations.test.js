...
describe('Container Operations', () => {
    ...
    describe('Basic State Operations', () => {
        ...
        it('should add and manage containers', () => {
            ...
            expect(container1?.style || 'default').toBe('default');
        });
    ...
    describe('Cross-Container Hyperedge Management', () => {
        ...
        it('should preserve cross-container hyperedges when expanding one container while other remains collapsed', () => {
            ...
            const crossContainerHyperEdges = afterCollapseB.filter(e => (e.source === 'containerA' && e.target === 'containerB') ||
            ...
            const nodeToContainerHyperEdges = afterExpandA.filter(e => (e.source === 'nodeA1' || e.source === 'nodeA2') && e.target === 'containerB' ||
...
//# sourceMappingURL=containerOperations.test.js.map