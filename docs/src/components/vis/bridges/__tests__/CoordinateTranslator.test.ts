...
function testElkToReactFlowTopLevel(): void {
...
function testElkToReactFlowChildElement(): void {
...
function testReactFlowToElkTopLevel(): void {
...
function testReactFlowToElkChildElement(): void {
...
function testRoundTripConversion(): void {
  ...
  assert.ok(
    Math.abs(backToChildELK.x - originalChildELK.x) < tolerance,
    `Child round-trip x should preserve coordinate: ${backToChildELK.x} ≈ ${originalChildELK.x}`
  );
  assert.ok(
    Math.abs(backToChildELK.y - originalChildELK.y) < tolerance,
    `Child round-trip y should preserve coordinate: ${backToChildELK.y} ≈ ${originalChildELK.y}`
  );
  
  console.log('    ✅ Round-trip coordinate conversion preserves original values');
}

function testGetContainerInfo(): void {
...
function testValidateConversion(): void {
...
export function runCoordinateTranslatorTests(): void {
