...
export class CoordinateTranslator {
     ...
     */
    static elkToReactFlow(elkCoords, parentContainer) {
        if (!parentContainer) {
     ...
     */
    static reactFlowToELK(reactFlowCoords, parentContainer) {
        if (!parentContainer) {
            // Top-level element: coordinates remain the same
            return {
                x: reactFlowCoords.x,
     ...
     */
    static getContainerInfo(containerId, visState) {
     ...
     */
    static validateConversion(originalELK, reactFlow, backToELK, parentContainer) {
     ...
     */
    static debugCoordinates(elementId, elkCoords, reactFlowCoords, parentContainer) {
