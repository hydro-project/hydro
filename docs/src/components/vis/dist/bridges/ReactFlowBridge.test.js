...
function testVisStateToReactFlowConversion() {
    ...
    const result = bridge.visStateToReactFlow(mockVisState);
...
function testParentChildMapping() {
    ...
    const parentMap = bridge.buildParentMap(mockVisState);
...
function testContainerConversion() {
...
function testHyperEdgeConversion() {
...
function testCustomPropertyExtraction() {
...
function testCoordinateTranslationIntegration() {
    ...
    const result = bridge.visStateToReactFlow(testVisState);
...
// ============ Run All Tests ============
export function runReactFlowBridgeTests() {
...
//# sourceMappingURL=ReactFlowBridge.test.js.map