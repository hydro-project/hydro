...
const FitIcon = () => (_jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "currentColor", children: _jsx("path", { d: "M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707zm4.344 0a.5.5 0 0 1 .707 0l4.096 4.096V11.5a.5.5 0 1 1 1 0v3.975a.5.5 0 0 1-.5.5H11.5a.5.5 0 0 1 0-1h2.768l-4.096-4.096a.5.5 0 0 1 0-.707zm0-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707zm-4.344 0a.5.5 0 0 1-.707 0L1.025 1.732V4.5a.5.5 0 0 1-1 0V.525a.5.5 0 0 1 .5-.5H4.5a.5.5 0 0 1 0 1H1.732l4.096 4.096a.5.5 0 0 1 0 .707z" }) }));
...
export function LayoutControls({ visualizationState, currentLayout = 'layered', onLayoutChange, colorPalette = 'Set2', onPaletteChange, onCollapseAll, onExpandAll, autoFit = false, onAutoFitToggle, onFitView, className, style }) {
    // Check if there are any containers that can be collapsed/expanded
    const hasContainers = visualizationState.visibleContainers.length > 0;
    const hasCollapsedContainers = visualizationState.visibleContainers.some(container => container.collapsed);
    const hasExpandedContainers = visualizationState.visibleContainers.some(container => !container.collapsed);
    return (_jsxs("div", { className: className, style: {
            ...
            fontSize: '14px',
            ...style
        }, children: [_jsx("select", { value: currentLayout, onChange: (e) => onLayoutChange?.(e.target.value), style: {
                    padding: '4px 8px',
                    border: '1px solid #ced4da',
                    borderRadius: '4px',
                    backgroundColor: '#fff',
                    fontSize: '14px'
                }, title: "Layout Algorithm", children: Object.entries(layoutOptions).map(([key, label]) => (_jsx("option", { value: key, children: label }, key))) }), _jsx("select", { value: colorPalette, onChange: (e) => onPaletteChange?.(e.target.value), style: {
                    padding: '4px 8px',
                    border: '1px solid #ced4da',
                    borderRadius: '4px',
                    backgroundColor: '#fff',
                    fontSize: '14px'
                }, title: "Color Palette", children: Object.entries(paletteOptions).map(([key, label]) => (_jsx("option", { value: key, children: label }, key))) }), _jsx("div", { style: { width: '1px', height: '20px', backgroundColor: '#dee2e6', margin: '0 4px' } }), _jsx("button", { onClick: onCollapseAll, disabled: !hasContainers || !hasExpandedContainers, title: !hasContainers
                    ? "No containers available"
                    : !hasExpandedContainers
                        ? "No containers to collapse"
                        : "Collapse All Containers", style: {
                    padding: '6px',
                    border: '1px solid #ced4da',
                    borderRadius: '4px',
                ...
                }, children: _jsx(PackIcon, {}) }), _jsx("button", { onClick: onExpandAll, disabled: !hasContainers || !hasCollapsedContainers, title: !hasContainers
                    ? "No containers available"
                    : !hasCollapsedContainers
                        ? "No containers to expand"
                        : "Expand All Containers", style: {
                    padding: '6px',
                    border: '1px solid #ced4da',
                    borderRadius: '4px',
                ...
                }, children: _jsx(UnpackIcon, {}) }), _jsx("div", { style: { width: '1px', height: '20px', backgroundColor: '#dee2e6', margin: '0 4px' } }), _jsx("button", { onClick: onFitView, title: "Fit graph to viewport", style: {
                    padding: '6px',
                    border: '1px solid #ced4da',
                    borderRadius: '4px',
                    backgroundColor: '#fff',
                    ...
                    alignItems: 'center',
                    justifyContent: 'center'
                }, children: _jsx(FitIcon, {}) }), _jsxs("label", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    gap: '4px',
                    cursor: 'pointer',
                    fontSize: '12px',
                    color: '#6c757d'
                }, title: "Automatically fit view after layout changes", children: [_jsx("input", { type: "checkbox", checked: autoFit, onChange: (e) => onAutoFitToggle?.(e.target.checked), style: { margin: 0 } }), "Auto Fit"] })] }));
}
