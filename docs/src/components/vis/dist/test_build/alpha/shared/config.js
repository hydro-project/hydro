 ...
 */
export function getStatusColor(status, variant = '500') {
    const statusMap = {
 ...
 */
export function getNodeBorderColor(style, selected, highlighted) {
    if (selected)
        return NODE_COLORS.BORDER.SELECTED;
    if (highlighted)
        return NODE_COLORS.BORDER.HIGHLIGHTED;
    switch (style) {
 ...
 */
export function getNodeTextColor(style) {
    switch (style) {
 ...
 */
export function getEdgeColor(style, selected, highlighted) {
    if (selected)
        return EDGE_COLORS.SELECTED;
    if (highlighted)
        return EDGE_COLORS.HIGHLIGHTED;
    switch (style) {
 ...
 */
export function getEdgeStrokeWidth(style) {
    switch (style) {
 ...
 */
export function getEdgeDashPattern(style) {
    switch (style) {
 ...
 */
export function getELKLayoutConfig(configKey) {
 ...
 */
export function getELKLayoutOptions(algorithm) {
    const baseOptions = {
