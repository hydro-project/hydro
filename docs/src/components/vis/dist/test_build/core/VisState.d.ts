...
export class VisualizationState {
     ...
     */
    _validateEntity(entity: any | null, conditionFn?: Function): boolean;
    /**
     ...
     */
    _validateRequiredString(value: any, fieldName: string): void;
    /**
     ...
     */
    _validateStyle(style: any, allowedStyles: any, entityType: string): void;
    /**
     ...
     */
    getGraphNode(id: string): any | undefined;
    /**
     ...
     */
    getGraphEdge(id: string): any | undefined;
    /**
     ...
     * ```
     */
    updateEdge(id: string, updates: Partial<{
        hidden: boolean;
        style: string;
    }>): this;
    /**
     ...
     */
    getContainer(id: string): any | undefined;
    /**
     ...
     * ```
     */
    updateContainer(id: string, updates: Partial<{
        collapsed: boolean;
        hidden: boolean;
        label: string;
    }>): this;
    ...
    setHyperEdge(id: string, { source, target, style, ...otherProps }: {
        ...
        originalInternalEndpoint?: string;
        otherProps?: any;
    }): VisualizationState;
    /**
     ...
     */
    getHyperEdge(id: string): any | undefined;
    /**
     * Remove a hyper edge
     ...
     * @private
     */
    private _addNodeToAllStructures;
    /**
     ...
     * @private
     */
    private _addEdgeToAllStructures;
    /**
     ...
     * @private
     */
    private _addContainerToAllStructures;
    /**
     ...
     * @private
     */
    private _addChildToContainerHierarchy;
    /**
     ...
     * @private
     */
    private _removeChildFromContainerHierarchy;
    /**
