...
function testEdgeStyleAggregation() {
    ...
    assert.strictEqual(state._aggregateEdgeStyles([defaultEdge]), EDGE_STYLES.DEFAULT, 'Single default edge should remain default');
    // Test priority: warning > highlighted > default
    assert.strictEqual(state._aggregateEdgeStyles([defaultEdge, highlightedEdge, warningEdge]), EDGE_STYLES.WARNING, 'Warning should have highest priority');
    // Test priority: thick > highlighted > default
    assert.strictEqual(state._aggregateEdgeStyles([defaultEdge, highlightedEdge, thickEdge]), EDGE_STYLES.THICK, 'Thick should have higher priority than highlighted');
...
export { testStateCreation, testNodeManagement, testEdgeManagement, testContainerManagement, testHyperEdgeManagement, testEntityRemovalHelpers, testContainerRemovalWithNestedHierarchy, testBulkClearOperation, testContainerCollapseExpand, testNestedContainers, testEdgeStyleAggregation, testClearState, testSimpleGrounding, testInverseOperations, runAllTests };
