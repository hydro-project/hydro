...
export class KeyGroupClass {
    constructor(position, width, height, key, keyName, color, backgroundColor = 'white') {
...
export class CollectionBoxClass {
    constructor(position, width, height, headerHeight, title, headerColor = '#666', borderColor = '#666', backgroundColor = 'white') {
        this.position = position; // Point object for center coordinates
        this.width = width;
        this.height = height;
...
export class OperatorBoxClass {
    constructor(position, width, height, text, backgroundColor = '#f0f0f0', borderColor = '#666', textColor = '#333') {
        this.position = position; // Point object for center coordinates
        this.width = width;
        this.height = height;
        this.text = text;
...
export class World {
    ...
    createCollectionBox(id, position, width, height, headerHeight, title, headerColor = '#666', borderColor = '#666', backgroundColor = 'white') {
    ...
    createOperatorBox(id, position, width, height, text, backgroundColor = '#f0f0f0', borderColor = '#666', textColor = '#333') {
    ...
    createKeyGroup(id, position, width, height, key, keyName, color, backgroundColor = 'white') {
        const group = new KeyGroupClass(position, width, height, key, keyName, color, backgroundColor);
