...
export class World {
    ...
    createCollectionBox(id, position, width, height, headerHeight, title, headerColor = '#666', borderColor = '#666', backgroundColor = "transparent") {
    ...
    createOperatorBox(id, position, width, height, text, backgroundColor = 'transparent', borderColor = '#666', textColor = 'inherit') {
