...
It is a chained `Iterator`-style syntax of operators built into DFIR.

In this chapter we go over the syntax piece by piece: how to [embed surface syntax in Rust](./surface_embedding.mdx) and how to specify [_flows_](./surface_flows.mdx), which consist of [_data sources_](./surface_data.mdx) flowing through [_operators_](./surface_ops_gen.md).
