...
import example3Out from "!!raw-loader!../../../../dfir_rs/examples/snapshots/example_surface_flows_3_ports.snap";
import example4Code from "!!raw-loader!../../../../dfir_rs/examples/example_surface_flows_4_context.rs";
import example4Out from "!!raw-loader!../../../../dfir_rs/examples/snapshots/example_surface_flows_4_context.snap";
...
unions the contents of many flows, so it can have an abitrary number of input ports. Some operators have multiple outputs; [`tee`](./surface_ops_gen.md#tee) and [`demux_enum`](./surface_ops_gen.md#demux_enum)
...
([`demux_enum`](./surface_ops_gen.md#demux_enum), [`tee`](./surface_ops_gen.md#tee))
...
[Here is the full API documentation for `Context`](rust:dfir_rs::runtime::context::Context).
