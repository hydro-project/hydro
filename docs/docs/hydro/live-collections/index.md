...
- **[Keyed Streams](./keyed-streams.mdx)** stream of items grouped by a key, with independent ordering for each group (API requests across several clients, "GROUP BY" aggregations)
