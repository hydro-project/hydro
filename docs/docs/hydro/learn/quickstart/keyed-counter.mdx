...
Just like in the concurrent clients counter, you'll establish consistency guarantees between increment acknowledgements and count snapshots. You start by marking the increment requests as atomic:
