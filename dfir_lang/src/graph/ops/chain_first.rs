...
///
/// Since `chain_first` has multiple input streams, it needs to be assigned to
...
/// my_chain = chain_first(3)
///     -> map(|x| x.to_uppercase())
///     -> assert_eq(["HELLO", "WORLD", "STAY"]);
/// ```
pub const CHAIN_FIRST: OperatorConstraints = OperatorConstraints {
    name: "chain_first",
